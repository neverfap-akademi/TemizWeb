...
def generate_social_layers(
    ...
    content_lines = [
        ...
        "! GENERATED FILE — edit scripts/generate_social.py instead.",
        "! Filters the smallest post/video/profile-result card while preserving",
        "! recovery, legal help, education, composing, uploading and publishing.",
        "! =============================================================================",
        "",
    ]
    count = 0
        ...
        for selector in selectors:
            for family_name, patterns in families.items():
                ...
                content_lines.extend(
                    (
                        f"! Rule {count}: {host} / {selector} / {family_name}",
                        _content_rule(
                            host,
                            selector,
                            patterns,
